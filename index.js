...
if (budy.toLowerCase() == jawaban) {
	alpha.sendButtonText(m.chat, [{ buttonId: 'math medium', buttonText: { displayText: 'Kuis Math' }, type: 1 }], ` 🎮 *KUIS MATEMATIKA TERJAWAB* 🎮\n\n「 ⭕ 」Jawaban Benar\n `, `© ${ownername}`, m)
delete kuismath[m.sender.split('@')[0]]
} else m.reply('*「 ✖️ 」Jawaban Salah!*')
}
...
if (budy.toLowerCase() == jawaban) {
await alpha.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `🎮 *TEBAK GAMBAR TERJAWAB* 🎮\n\n「 ⭕ 」Jawaban Benar\n\n `, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await alpha.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `🎮 *TEBAK KATA TERJAWAB* 🎮\n\n「 ⭕ 」Jawaban Benar\n\n `, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await alpha.sendButtonText(m.chat, [{ buttonId: 'tebak bendera', buttonText: { displayText: 'Tebak Bendera' }, type: 1 }], `🎮 *TEBAK BENDERA TERJAWAB* 🎮\n\n「 ⭕ 」Jawaban Benar\n\n `, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await alpha.sendButtonText(m.chat, [{ buttonId: 'caklontong', buttonText: { displayText: 'Cak Lontong' }, type: 1 }], `🎮 *CAK LONTONG TERJAWAB* 🎮\n\n「 ⭕ 」Jawaban Benar\n\n `, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await alpha.sendButtonText(m.chat, [{ buttonId: 'susunkata', buttonText: { displayText: 'Susun Kata' }, type: 1 }], `🎮 *SUSUN KATA TERJAWAB* 🎮\n\n「 ⭕ 」Jawaban Benar\n\n `, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await alpha.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `🎮 *TEBAK KALIMAT TERJAWAB* 🎮\n\n「 ⭕ 」Jawaban Benar\n\n `, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await alpha.sendButtonText(m.chat, [{ buttonId: 'tebak siapa', buttonText: { displayText: 'Tebak Siapa' }, type: 1 }], `🎮 *TEBAK SIAPA TERJAWAB* 🎮\n\n「 ⭕ 」Jawaban Benar\n\n `, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await alpha.sendButtonText(m.chat, [{ buttonId: 'tekateki', buttonText: { displayText: 'Teka Teki' }, type: 1 }], `🎮 *TEKA TEKI TERJAWAB* 🎮\n\n「 ⭕ 」Jawaban Benar\n\n `, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await alpha.sendButtonText(m.chat, [{ buttonId: 'tebak kabupaten', buttonText: { displayText: 'Tebak Kabupaten' }, type: 1 }], `🎮 *TEBAK KABUPATEN TERJAWAB* 🎮\n\n「 ⭕ 」Jawaban Benar\n\n `, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await alpha.sendButtonText(m.chat, [{ buttonId: 'tebak kimia', buttonText: { displayText: 'Tebak Kimia' }, type: 1 }], `🎮 *TEBAK KIMIA TERJAWAB* 🎮\n\n「 ⭕ 」Jawaban Benar\n\n `, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await alpha.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `🎮 *TEBAK LIRIK TERJAWAB* 🎮\n\n「 ⭕ 」Jawaban Benar\n\n `, `© ${ownername}`, m)
...
if (budy.toLowerCase() == jawaban) {
await alpha.sendButtonText(m.chat, [{ buttonId: 'tebak tebakan', buttonText: { displayText: 'Tebak Tebakan' }, type: 1 }], `🎮 *TEBAK TEBAKAN TERJAWAB* 🎮\n\n「 ⭕ 」Jawaban Benar\n\n `, `© ${ownername}`, m)
...
reply(`「 🗑️ 」Absen Berhasil Dihapus`)
}
break
...
case 'listgc': {
  ...
  for (let e of anu) {
  let metadata = await alpha.groupMetadata(e)
  ...
  alpha.sendTextWithMentions(m.chat, tekslistgc, m)
  }
  break
case 'wallanime':
  reply(mess.wait)
  ...
  break
	    case 'toimage': case 'toimg': {
            ...
            case 'wallpaper': {
				...
				await alpha.send5ButImg(from, `💬Title : ${result.title}\n📃Source : ${result.source}\n🖇️Media Url : ${result.image}` , `© ${ownername}`,gam, but , { userJid: m.chat, quoted: m })
				})
				.catch((err) => {
                    reply(lang.err())
                })
            ...
            break
           case 'timerun': case 'runtime':
            reply(`⏱️Runtime : ${runtime(process.uptime())}`)
            break
            case 'public': {
                if (!m.key.fromMe && !isCreator) return reply(lang.ownerOnly())
                alpha.public = true
          ...
          {
            "urlButton": {
              "displayText": "YouTube Development▶️",
              "url": `${youtube}`
            }
          },
          {
...
case 'speed': case 'tes':
  ...
  break
 case 'status': case 'info': case 'infobot': case 'statusbot': {
  let timestamp = speed()
  let latensi = speed() - timestamp
  neww = performance.now()
  oldd = performance.now()
  let txtping = `*I N F O  B O T*\n\n`
  txtping += `*🤴 Owner Name :* ${global.ownername}\n`
  txtping += `*🤖 Nama Bot :* ${global.botname}\n`
  txtping += `*🖇️ No. Owner :* wa.me/${global.ownernomer}\n\n`
  txtping += `*I N F O  S T A T I S T I K*\n\n`
  ...
  alpha.send5ButImg(m.chat, txtping, `© ${global.botname}`, imgping )
  }
  break
            case 'jodohku': {
            if (!m.isGroup) throw mess.group
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await alpha.sendButtonText(m.chat, buttons, jawab, zaki.user.name, m, {mentions: ments})
            }
            break
            case 'jadian': {
            if (!m.isGroup) throw mess.group
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await alpha.sendButtonText(m.chat, buttons, jawab, zaki.user.name, m, {mentions: menst})
            }
            break
            case 'apakah':
...
case 'cekmati':
              ...
              m.reply(`💬Nama : ${predea.data.name}\n*⚰️Mati Pada Umur :* ${predea.data.age} Tahun.\n\n_TOBAT_`)
              break
...
alpha.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], "⏱️Waktu Habis\n🔍Jawaban: " + result.jawaban , `© ${ownername}`, m)
delete tebakgambar[m.sender.split('@')[0]]
}
} 
case 'tebakkata': {
...
alpha.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], "⏱️Waktu Habis\n🔍 Jawaban: " + result.jawaban , `© ${ownername}`, m)
delete tebakkata[m.sender.split('@')[0]]
}
} 
case 'tebakbendera': {
...
alpha.sendButtonText(m.chat, [{ buttonId: 'tebak bendera', buttonText: { displayText: 'Tebak Bendera' }, type: 1 }], "⏱️Waktu Habis\n🔍Jawaban: " + result.name , `© ${ownername}`, m)
delete tebakbendera[m.sender.split('@')[0]]
}
} 
case 'tebakkalimat': {
...
let result = anu[Math.floor(Math.random() * anu.length)]
alpha.sendText(m.chat, `👁️‍🗨️Apa Arti Dari Simbol : *${result.lambang}*?\n⏳Waktu : 60s`, m).then(() => {
...
alpha.sendButtonText(m.chat, [{ buttonId: 'caklontong', buttonText: { displayText: 'Cak Lontong' }, type: 1 }], `⏱️Waktu Habis\n🔍Jawaban : ${result.jawaban}\nDeskripsi : ${result.deskripsi}` , `© ${ownername}`, m)
delete caklontong[m.sender.split('@')[0]]
}
}
break
...
alpha.sendButtonText(m.chat, [{ buttonId: 'susunkata', buttonText: { displayText: 'Susun Kata' }, type: 1 }], `⏱️Waktu Habis\n🔍Jawaban : ${result.jawaban}` , `© ${ownername}`, m)
delete susunkata[m.sender.split('@')[0]]
}
}
break
...
if (tekateki.hasOwnProperty(m.sender.split('@')[0])) {
	alpha.sendButtonText(m.chat, [{ buttonId: 'tekateki', buttonText: { displayText: 'Teka Teki' }, type: 1 }], `⏱️Waktu Habis\n🔍Jawaban : ${result.jawaban}` , `© ${ownername}`, m)
delete tekateki[m.sender.split('@')[0]]
}
}
break
            ...
            break
				case 'menu':{
					if(typemenu == 'templateLocation'){
						await alpha.send5ButLoc(from, lang.menunya(salam, pushname, botname) , `© ${ownername}`,pp_bot, [{"urlButton": {"displayText": "YouTube Development▶️","url": `${youtube}`}},{"urlButton": {"displayText": "Bot Group👥","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'ownerr'}},{"quickReplyButton": {"displayText": "List Command","id": 'command'}}] )
							}
						if(typemenu == 'templateTenor'){
							alpha.send5ButGif(from, lang.menunya(salam, pushname, botname) , `© ${ownername}` ,pp_bot, [{"urlButton": {"displayText": "YouTube Development▶️","url": `${youtube}`}},{"urlButton": {"displayText": "Bot Group👥","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'ownerr'}},{"quickReplyButton": {"displayText": "List Command","id": 'command'}}] , {quoted: m})
						 }
						if(typemenu == 'katalog'){
					...
					break    
	case 'allmenu':{
			await alpha.send5ButLoc(from, `Hai ${pushname}\nSaya *${botname}* ` + '\n\n' + lang.listMenu(time, salam, pushname, prefix) , `© ${ownername}`,pp_bot, [{"urlButton": {"displayText": "YouTube Development▶️","url": `${youtube}`}},{"urlButton": {"displayText": "Bot Group👥","url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'ownerr'}},{"quickReplyButton": {"displayText": "Rules","id": 'rules'}}] )
		}
	break   
	case 'infocmd': case'infomenu':{
		alpha.sendButImage(m.chat, sender, [{buttonId: '.command',buttonText:{displayText: '↩️BACK'},type: 1},{buttonId:'ownerr',buttonText: {displayText:'OWNER👤'}, type: 1}], `Selamat ${salam} @${sender.split('@')[0]}\n\n╭━━━━┈⎔ *INFO BOT*\n├❏ *Bot Name* : ⌬ Hatsune-Bot\n├❏ *Owner* : ${ownername}\n├❏ *Version* : 3.0\n├❏ *Perfix* : Multi\n├❏ *Total Features* : 700+\n├❏ *Lib* : Baileys-Md@4.0.0\n├❏ *Ram* : ${formatp(os.totalmem() - os.freemem())}/${formatp(os.totalmem())}\n╰───────────────┈⎔` + '\n\n' +  lang.info(prefix), `© ${ownername}`, [sender, ownernomer + '@s.whatsapp.net'], {quoted:m})
      }
  break 
...
break
			...
			case 'ramalanjodoh': case 'ramaljodoh': {
                if (!text) throw `Example : ${prefix + command} Hatsune, 12, 1, 2004, Clara, 22, 2, 2004`
            ...
            break
            case 'artinama': {
                if (!text) throw `Example : ${prefix + command} Hatsune`
            ...
            case 'kecocokannama': case 'cocoknama': {
                if (!text) throw `Example : ${prefix + command} Hatsune, 12, 1, 2004`
            ...
            case 'kecocokanpasangan': case 'cocokpasangan': case 'pasangan': {
                if (!text) throw `Example : ${prefix + command} Hatsune|Clara`
            ...
            break
            case 'fengshui': {
                if (!text) throw `Example : ${prefix + command} Hatsune, 1, 2004\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
            ...
            break
            case 'peruntungan': {
                if (!text) throw `Example : ${prefix + command} Hatsune, 12, 1, 2004, 2022\n\nNote : ${prefix + command} Nama, tanggal lahir, bulan lahir, tahun lahir, untuk tahun`
...
if (!text) return reply(`Kirim perintah ${prefix + command} *Hatsune*`)
reply(lang.wait())
...
if (!text) return reply(`Kirim perintah ${prefix + command} *Hatsune|Bot*`)
if (!text.includes('|')) return reply(`Kirim perintah ${prefix + command} *Hatsune|Bot*`)
mm = args.join(' ')
m1 = mm.split("|")[0];
m2 = mm.split("|")[1]; 
reply(lang.wait())
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'astronotspace':{
	if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Hatsune|anubis`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Hatsune|anubis`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'wallpaperaov':{
	if (!text) return reply(`Ex: ${prefix + command} nama|heroes\nUsage: ${prefix + command} Hatsune|allain`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|heroes\nUsage: ${prefix + command} Hatsune|allain`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'wallpaperml':{
	if (!text) return reply(`Ex: ${prefix + command} nama|heroes\nUsage: ${prefix + command} Hatsune|aldous`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|heroes\nUsage: ${prefix + command} Hatsune|aldous`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'bannerofaov':{
	if (!text) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} Hatsune|aphelios`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} Hatsune|aphelios`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'cutegirlgamer':{
	if (!text) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Hatsune|style-1`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Hatsune|style-1`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'footballteam':{
	if (!text) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Hatsune|nau-1`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Hatsune|nau-1`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	case 'elegantrotation':{
		if (!text) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Hatsune|bull`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Hatsune|bull`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {video:{ url: textpro2}, mimetype: 'video/mp4', caption: lang.ok()}, {quoted:m})
	...
	break
case 'gaminglogo4fvs':{
	if (!text) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Hatsune|ghost`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Hatsune|ghost`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'blueneon':{
		if (!text) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Hatsune|tiger`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|logo\nUsage: ${prefix + command} Hatsune|tiger`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'anonymous':{
	if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Hatsune|style2`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Hatsune|style2`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'lolpentakill':{
		if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Hatsune|kassadin`)
	if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Hatsune|kassadin`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Hatsune|arum-6`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Hatsune|arum-6`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'avatarff':{
if (!text) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} Hatsune|laura`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} Hatsune|laura`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
if (!text) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Hatsune|ashe-2`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|style\nUsage: ${prefix + command} Hatsune|ashe-2`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'crossfirecover':{
if (!text) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} Hatsune|blthefates`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} Hatsune|blthefates`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
if (!text) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} Hatsune|dieuthuyen`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|character\nUsage: ${prefix + command} Hatsune|dieuthuyen`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
case 'newlolavatar':{
if (!text) return reply(`Ex: ${prefix + command} nama|avatar\nUsage: ${prefix + command} Hatsune|rammus`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|avatar\nUsage: ${prefix + command} Hatsune|rammus`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'csgocover':{
if (!text) return reply(`Ex: ${prefix + command} nama|background\nUsage: ${prefix + command} Hatsune|karambit`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|background\nUsage: ${prefix + command} Hatsune|karambit`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
...
alpha.sendMessage(from, {image:{ url: textpro2}, caption: lang.ok()}, {quoted:m})
	...
	break
	case 'crossfirestyle':{
if (!text) return reply(`Ex: ${prefix + command} nama|avatar\nUsage: ${prefix + command} Hatsune|swat`)
if (!text.includes('|')) return reply(`Ex: ${prefix + command} nama|avatar\nUsage: ${prefix + command} Hatsune|swat`)
var mon = args.join(' ')
var m1 = mon.split("|")[0]
var m2 = mon.split("|")[1]
